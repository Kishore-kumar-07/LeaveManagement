...
const Leaveform = () => {
  ...
  const shouldDisableToDate = (date) => {
    ...
    return date.day() === 0 || date.day() === 6 || date.month() !== fromDate.month();
  };
  ...
  >
    ...
    <div className="w-full mb-4">
      ...
      <div className="flex gap-4 flex-wrap">
        {["Casual Leave", "Privilege Leave", "Paternity Leave"].map((type) => (
    ...
    <div className="w-full mb-4 flex flex-wrap gap-4 items-center">
      ...
      <div className="flex gap-4">
        <button
          ...
          className={`p-2 rounded-md ${isHalfDayFrom ? "bg-blue-500 text-white" : "bg-gray-200"}`}
        >
          Half Day
        </button>
        <button
    ...
    <div className="w-full mb-4 flex flex-wrap gap-4 items-center">
      ...
      <div className="flex gap-4">
        <button
          ...
          className={`p-2 rounded-md ${isHalfDayTo ? "bg-blue-500 text-white" : "bg-gray-200"}`}
        >
          Half Day
        </button>
        <button
    ...
    {/* Leave Reason */}
    <div className="w-full mb-4">
      <label className="block text-gray-700 mb-2 text-lg">Leave Reason</label>
      <div className="flex gap-4 flex-wrap">
    ...
    {leaveReason === "Other" && (
      <div className="w-full mb-3">
        <label className="block text-gray-700 mb-2 text-lg">Leave Description</label>
        <textarea
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full md:w-[70%] overflow-x-auto">
        <div className="flex justify-between">
          <h3 className="text-xl font-bold mb-4 text-blue-800">Leave Details</h3>
          <h3
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">{leaveDetails.numOfDays}</td>
            </tr>
            <tr>
            ...
            {leaveDetails.leaveDescription && (
              <tr>
                <td className="border border-gray-300 p-2">Leave Description</td>
