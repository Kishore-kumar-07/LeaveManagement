  ...
  return (
    <>
      <div className='w-full flex justify-center items-center  rounded-lg p-5'>
        <div  style={{ boxShadow: "0 -4px 6px -1px rgba(0, 0, 0, 0.1), 0 4px 6px -1px rgba(0, 0, 0, 0.1)" }} className='w-[100%]  flex justify-between items-center px-5 py-2 rounded-lg backdrop-blur-sm'>
